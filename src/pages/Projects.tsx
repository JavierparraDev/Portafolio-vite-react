        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          {featuredProject && (
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl border border-gray-200 dark:border-gray-800 bg-gradient-to-br from-gray-100 to-white dark:from-gray-900/80 dark:to-gray-950"
            >
