              ...
              {experiences.map((exp, idx) => (
                <motion.div key={idx} variants={itemVariants} className="relative">
                  ...
                  <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 -translate-y-1/2 top-8">
                    <motion.div
                      className={`relative w-8 h-8 rounded-full border-4 border-gray-50 dark:border-gray-900 bg-gradient-to-r ${getGradientColor(idx)} flex items-center justify-center cursor-pointer`}
                    ...
                    >
                      ...
                      <div className="relative w-4 h-4 rounded-full bg-gray-50 dark:bg-gray-950"></div>
                    </motion.div>
                  </div>
                  ...
                  >
                    <motion.button
                      ...
                      className={`w-full group relative overflow-hidden rounded-2xl backdrop-blur-xl border transition-all duration-300 ${
                        activeIndex === idx
                          ...
                          : 'bg-white/80 border-gray-200 hover:border-gray-300 hover:bg-white dark:bg-gray-900/40 dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900/60'
                      }`}
                    >
                      ...
                      <div className="relative p-6 md:p-8">
                        ...
                        {/* Description */}
                        <p className="text-gray-600 dark:text-gray-400 text-sm mt-4 leading-relaxed">{exp.description}</p>

                        {/* Expand Indicator */}
                        <motion.div
                          className="mt-4 flex items-center gap-2 text-blue-600 dark:text-blue-400 text-sm font-medium"
                    ...
                    <AnimatePresence mode="wait">
                      {activeIndex === idx && (
                        ...
                        >
                          <div className="rounded-2xl bg-gradient-to-br from-white to-gray-100 border border-gray-200 p-6 md:p-8 space-y-6 backdrop-blur-xl dark:from-gray-900/80 dark:to-gray-800/40 dark:border-gray-800">
                            {/* Achievements */}
                            <div>
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-800 pt-6">
                              <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-4">{t('experience.techStack')}</h4>
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {exp.tech.map((category, i) => (
                                  ...
                                  >
                                    <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 mb-2">{category.label}</p>
